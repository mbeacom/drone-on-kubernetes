...
then
  ...
  echo
  echo "Excellent. This will be the IP address that you can create a DNS (A)"
  echo "record for, or point your browser at directly."
  read -p "<Press enter to proceed once you have noted your External IP>"
fi
...
echo "Once you see 1/1 READY for your drone-server-* pod, point your browser"
echo "at http://<your-external-ip-here> and you should see a login page."
echo
